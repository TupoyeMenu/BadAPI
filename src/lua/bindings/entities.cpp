...
namespace lua::entities
{
	...
	static auto get_all_vehicles_as_handles()
	{
		return sol::as_table(big::pools::get_all_vehicles_array());
	}
	...
	static auto get_all_peds_as_handles()
	{
		return sol::as_table(big::pools::get_all_peds_array());
	}
	...
	static auto get_all_objects_as_handles()
	{
		return sol::as_table(big::pools::get_all_props_array());
	}
