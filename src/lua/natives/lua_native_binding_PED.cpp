...
namespace lua::native
{
	...
	static bool LUA_NATIVE_PED_IS_PED_IN_SPHERE_AREA_OF_ANY_ENEMY_PEDS(Ped ped, float x, float y, float z, float range)
	{
		auto retval = (bool)PED::IS_PED_IN_SPHERE_AREA_OF_ANY_ENEMY_PEDS(ped, x, y, z, range);
		return retval;
	}
	...
	void init_native_binding_PED(sol::state& L)
	{
		...
		PED.set_function("IS_PED_IN_SPHERE_AREA_OF_ANY_ENEMY_PEDS", LUA_NATIVE_PED_IS_PED_IN_SPHERE_AREA_OF_ANY_ENEMY_PEDS);
